...
klucz bezwarunkowej kapitulacji, abstynencji, mityngów i programu SLAA. Dzieląc się ze sobą swoją historią, za każdym razem przekręcam w dobrą stronę klucz w kajdanach mojego uzależnienia.
 ...
 Modlę się, abym słuchał doświadczeń trzeźwych SLAA. Modlę się, abym nie uciekał przed właściwym rozwiązaniem: dzieleniem się sobą. Modlę się, abyś - w każdej pułapce - Siłą Wyższa podsuwał mi pasujący klucz.
